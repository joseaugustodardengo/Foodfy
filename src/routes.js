...
routes.post("/admin/chefs",multer.single("photos", 1), chefs.store) // Armazenar nova receita
routes.put("/admin/chefs",multer.single("photos", 1), chefs.update); // Atualizar receita
